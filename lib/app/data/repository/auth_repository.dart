import 'package:flutter_kasir/app/data/model/auth.dart';
import 'package:flutter_kasir/app/data/source/auth_api_service.dart';
import 'package:flutter_kasir/app/domain/repository/auth_repository.dart';
...
class AuthRepositoryImpl extends AuthRepository {
  ...
  Future<DataState> login(AuthEntity param) {
    return handleResponse(() => _authApiService.login(body: param.toJson()), (
      ...
      await SharedPreferencesHelper.setString(PREF_AUTH, authModel.accessToken);
